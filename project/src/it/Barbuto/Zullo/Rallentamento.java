...
public class Rallentamento extends DataFrame {

    public Rallentamento() {
        initComponents();
        setModalita(APPEND_QUERY);
        setFrameTable(tableRallentamento);
        setNomeTabella("Rallentamento");
   ...
   private void ComboBoxInfoLive(JComboBox cb){
    ...
    protected void mostraErrori(SQLException e, String query, int contesto) {
      String msg;
      if (e.getErrorCode() == 1) {
         msg = "Esiste già un'altro Rallentamento con lo stesso identificativo";
     ...
     protected void premutoOK() {
      if (getPadre() != null) {
         getPadre().setProprietaPadre("Rallentamento", getIdText().getText());
         try {
            rs.close();
   ...
   protected PreparedStatement getComandoInserimento(Connection c)
      ...
      String cmdIns;
      PreparedStatement st;
      cmdIns = "insert into " + Database.schema + ".Rallentamento (Identificativo,IdInfoLive) values(?,?)";
   ...
   protected PreparedStatement getComandoAggiornamento(Connection c)
      ...
      String cmdUp;
      PreparedStatement st;
      cmdUp = "update " + Database.schema + ".Rallentamento set IdInfoLive=?"
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        tableRallentamento = new javax.swing.JTable();
        ...
        setTitle("Rete Autostradale - Rallentamento");

        tableRallentamento.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
            ...
            new String [] {
                "Id Rallentamento", "Id Info Live"
            }
        ));
        jScrollPane1.setViewportView(tableRallentamento);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tIdInfoLive, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30)
                        .addComponent(comboInfoLive, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rallentamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Rallentamento().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableRallentamento;
